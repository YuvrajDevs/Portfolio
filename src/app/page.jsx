...
const Homepage = () => {
  return (
    ...
    <div className="h-full flex flex-col gap-3 lg:gap-32 lg:mt-10  px-4  sm:px-8  md:px-12 lg:px-20 xl:px-48 lg:flex-row ">

    <div className="w-full h-1/2 p-10 relative  lg:w-1/2 lg:h-full">
    <Image src="/hero.jpg" className="object-contain" fill />
    </div>

    <div className="w-full flex flex-col justify-center h-1/2  relative lg:pb-[100px] lg:w-1/2 lg:h-full">
      <h1 className={`${elsie.className} pt-5 text-[45px]  leading-[50px] md:text-[65px] md:mb-5 lg:text-[64px] lg:mb-6 lg:leading-[60px]`}> Crafting pixels,<br></br> shaping websites.</h1>
